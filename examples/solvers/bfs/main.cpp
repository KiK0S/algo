...
inline BfsResult bfs_multi_source(const std::vector<std::vector<int>>& graph,
  ...
  while (!q.empty()) {
    const int v = q.front();
    q.pop();
    EDULCNI_VIS(edulcni::clear_graph_highlights("bfs.graph"));
    EDULCNI_VIS(edulcni::highlight_vertex("bfs.graph", v));
    EDULCNI_VIS(edulcni::live::queue("bfs.frontier", q));
    ...
    for (int to : graph[v]) {
      ...
      q.push(to);
      EDULCNI_VIS(edulcni::highlight_edge("bfs.graph", v, to));
      EDULCNI_VIS(edulcni::highlight_vertex("bfs.graph", to));
      EDULCNI_VIS(edulcni::live::array("bfs.distance", result.distance));
      EDULCNI_VIS(edulcni::live::array("bfs.parent", result.parent));
      EDULCNI_VIS(edulcni::live::queue("bfs.frontier", q));
