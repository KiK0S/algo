...
// Catalog entry: /templates/fast_allocator
...
class FastAllocatorArena {
 public:
  ...
  void* allocate(std::size_t bytes,
    ...
    offset_ = pos;
    trace("Allocator arena allocated a block");
 ...
 private:
  ...
  void trace(const char* label) const {
    EDULCNI_VIS(edulcni::live::gauge(
        "fast_allocator.used", storage_.size() - offset_, storage_.size()));
    EDULCNI_STEP(label);
  }
};
