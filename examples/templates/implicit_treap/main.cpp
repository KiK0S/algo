...
// Catalog entry: /templates/implicit_treap
...
class ImplicitTreap {
 ...
 public:
  ...
  void insert(int position, const T& value) {
    ...
    trace_operation("Implicit treap inserted an element");
  }
  ...
  bool erase(int position, T* erased_value = nullptr) {
    ...
    root_ = merge(left_mid.first, mid_right.second);
    trace_operation("Implicit treap erased an element");
    return true;
  }
  ...
  bool set(int position, const T& value) {
    ...
    mid_right.first->aggregate = value;
    clear_lazy(mid_right.first);
    pull(mid_right.first);
    root_ = merge(left_mid.first, merge(mid_right.first, mid_right.second));
    trace_operation("Implicit treap updated an element");
    return true;
  }
  ...
  void reverse(int left, int right) {
    ...
    root_ = merge(left_mid.first, merge(mid_right.first, mid_right.second));
    trace_operation("Implicit treap reversed a range");
  }
  ...
  std::vector<T> to_vector() {
    ...
    EDULCNI_VIS(edulcni::live::array("implicit_treap.sequence", values));
    EDULCNI_STEP("Implicit treap materialized its sequence");
    return values;
  }
 ...
 private:
  ...
  void trace_operation(const char* label) const {
    EDULCNI_VIS(edulcni::live::scalar("implicit_treap.size", size()));
    EDULCNI_STEP(label);
  }
  ...
  static void clear_lazy(Node* node) {
    if (node == nullptr) {
      return;
    }
